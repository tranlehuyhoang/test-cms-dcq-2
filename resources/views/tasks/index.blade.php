                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <a href="{{ route('task.add', 0) }}" class="btn btn-primary waves-effect waves-light"><i class='fe-plus me-1'></i>Add New</a>
                                        </div>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="custom-accordion">
                                        ...
                                        foreach ($arProject as $idProject => $nameProject) {
                                            ?>
                                            <div class="mt-4">
                                                <h5 class="position-relative mb-0"><a href="{{ route('project.edit', $idProject) }}" target="_blank"><?php echo $nameProject;?> </a> <a href="#taskcollapse<?php echo $idProject;?>" class="text-dark" data-bs-toggle="collapse"><i class="mdi mdi-chevron-down accordion-arrow"></i></a></h5>
                                                        ...
                                                        <table class="table table-centered table-nowrap table-borderless table-sm">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                foreach ($arTasks as $key => $value) {
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <span class="ms-0"><i class="fe-chevron-right"></i></span>
                                                                        ...
                                                                        <td>
                                                                            <div>
                                                                                <img src="/assets/images/users/avatar-2.jpg" alt="image" class="avatar-sm img-thumbnail rounded-circle" title="Houston Fritz" />
                                                                        ...
                                                                        <td><span class="badge <?php echo $priority?> p-1 <?php echo $classStatus;?>"><?php echo $value['priority']?></span></td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <ul class="list-inline table-action m-0">
                                                                                <li class="list-inline-item"> 
                                                                                    <a href="{{ route('task.edit', $value['id']) }}" class="action-icon px-1"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                                                </li>
                                                                                <li class="list-inline-item"> 
                                                                                    <div class="dropdown">
