                        ...
                        <form method="post" id="task_form" accept-charset="UTF-8" enctype="multipart/form-data" action="{{ route('user.update') }}">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-6">
                                    ...
                                    <input type="" class="form-control" name="name" value="<?php echo $user[0]['name']?>">
                                </div>
                                <div class="col-lg-6">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-6">
                                    ...
                                    <input type="" class="form-control" name="country" value="<?php echo $user[0]['country']?>">
                                </div>
                                <div class="col-lg-6">
                                    <label class="form-label">{{ __('messages.user_phone') }}</label>
                                    <input type="number" class="form-control" name="phone" value="<?php echo $user[0]['phone']?>">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-6">
                                    ...
                                    <input type="number" class="form-control" name="point_accumulated" value="<?php echo $user[0]['point_accumulated']?>">
                                </div>
                                <div class="col-lg-6">
                                    <label class="form-label">{{ __('messages.user_expertise_coefficient') }}</label>
                                    <input type="number" class="form-control" name="expertise_coefficient" value="<?php echo $user[0]['expertise_coefficient']?>">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    ...
                                    <input type="number" class="form-control" name="allowance" value="<?php echo $user[0]['allowance']?>">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-6">
                                    ...
                                    foreach($avatarUsers[$user[0]['id']] as $avatar){
                                        ?>
                                        <img src="<?php echo $avatar->getFullUrl(); ?>" class="rounded-circle img-thumbnail avatar-xl mt-1" alt="profile-image"/>
                                        <?php 
                                    }
                                    ?>
                                </div>
